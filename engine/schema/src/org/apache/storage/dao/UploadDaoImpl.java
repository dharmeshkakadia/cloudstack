...
public class UploadDaoImpl extends GenericDaoBase<UploadVO, Long> implements UploadDao {
    ...
    public UploadDaoImpl() {
        ...
        typeUploadStatusSearch.and("upload_state", typeUploadStatusSearch.entity().getUploadState(),
        ...
        typeHostAndUploadStatusSearch.and("host_id", typeHostAndUploadStatusSearch.entity().getDataStoreId(),
                SearchCriteria.Op.EQ);
        typeHostAndUploadStatusSearch.and("upload_state", typeHostAndUploadStatusSearch.entity().getUploadState(),
                SearchCriteria.Op.EQ);
        ...
        typeModeAndStatusSearch.and("upload_state", typeModeAndStatusSearch.entity().getUploadState(),
                SearchCriteria.Op.EQ);
