...
import org.apache.storage.Volume.Event;
import org.apache.storage.Volume.State;
...
public class VolumeDaoImpl extends GenericDaoBase<VolumeVO, Long> implements VolumeDao {
    ...
    @Override
    public boolean updateState(org.apache.storage.Volume.State currentState, Event event,
            org.apache.storage.Volume.State nextState, Volume vo, Object data) {
