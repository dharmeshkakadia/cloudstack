...
import org.apache.bridge.util.XElement;
import org.apache.bridge.util.XSerializer;
import org.apache.bridge.util.XSerializerJsonAdapter;
import org.apache.bridge.util.XSerializerXmlAdapter;
import org.apache.gate.testcase.BaseTestCase;
...
class Foo extends BaseFoo {
	...
	@XElement(name="SubObjects", item="ListItem", itemClass="org.apache.gate.util.SubFoo")
	public List<SubFoo> subs;
	
	@XElement(name="ArrayObjects", item="ArrayItem", itemClass="org.apache.gate.util.SubFoo")
...
public class UtilTestCase extends BaseTestCase {
	...
	public void testXml2Java() {
		...
		try {
			InputStream is = this.getClass().getResourceAsStream("/org/apache/gate/util/Xml2JavaTestData.xml");
