...
import org.apache.bridge.io.S3CAStorBucketAdapter;
import org.apache.bridge.io.S3FileSystemBucketAdapter;
import org.apache.bridge.model.BucketPolicyVO;
import org.apache.bridge.model.MHostMountVO;
import org.apache.bridge.model.MHostVO;
import org.apache.bridge.model.SAcl;
import org.apache.bridge.model.SAclVO;
import org.apache.bridge.model.SBucket;
import org.apache.bridge.model.SBucketVO;
import org.apache.bridge.model.SHost;
import org.apache.bridge.model.SHostVO;
import org.apache.bridge.model.SMetaVO;
import org.apache.bridge.model.SObjectItemVO;
import org.apache.bridge.model.SObjectVO;
import org.apache.bridge.persist.dao.BucketPolicyDao;
import org.apache.bridge.persist.dao.MHostDao;
import org.apache.bridge.persist.dao.MHostMountDao;
import org.apache.bridge.persist.dao.MultipartLoadDao;
import org.apache.bridge.persist.dao.SAclDao;
import org.apache.bridge.persist.dao.SBucketDao;
import org.apache.bridge.persist.dao.SHostDao;
import org.apache.bridge.persist.dao.SMetaDao;
import org.apache.bridge.persist.dao.SObjectDao;
import org.apache.bridge.persist.dao.SObjectItemDao;
import org.apache.bridge.service.UserContext;
import org.apache.bridge.service.controller.s3.ServiceProvider;
import org.apache.bridge.service.core.s3.S3BucketPolicy.PolicyAccess;
import org.apache.bridge.service.core.s3.S3CopyObjectRequest.MetadataDirective;
import org.apache.bridge.service.core.s3.S3PolicyAction.PolicyActions;
import org.apache.bridge.service.core.s3.S3PolicyCondition.ConditionKeys;
import org.apache.bridge.service.exception.HostNotMountedException;
import org.apache.bridge.service.exception.InternalErrorException;
import org.apache.bridge.service.exception.InvalidBucketName;
import org.apache.bridge.service.exception.NoSuchObjectException;
import org.apache.bridge.service.exception.ObjectAlreadyExistsException;
import org.apache.bridge.service.exception.OutOfServiceException;
import org.apache.bridge.service.exception.OutOfStorageException;
import org.apache.bridge.service.exception.PermissionDeniedException;
import org.apache.bridge.util.DateHelper;
import org.apache.bridge.util.OrderedPair;
import org.apache.bridge.util.PolicyParser;
import org.apache.bridge.util.StringHelper;
import org.apache.bridge.util.Triple;
