...
import org.apache.agent.manager.MockAgentManager;
...
public class SimulatorDiscoverer extends DiscovererBase implements Discoverer, Listener, ResourceStateAdapter {
     ...
     *
     * @see org.apache.resource.Discoverer#find(long, java.lang.Long,
            ...
            for( VMTemplateVO tmplt : tmplts ) {
                ...
                if (vmTemplateHost == null) {
                    vmTemplateHost = new VMTemplateHostVO(host.getId(), tmplt.getId(), new Date(), 100,
                            org.apache.storage.VMTemplateStorageResourceAssoc.Status.DOWNLOADED, null, null, null, null, tmplt.getUrl());
                    _vmTemplateHostDao.persist(vmTemplateHost);
                } else {
                    vmTemplateHost.setDownloadState(org.apache.storage.VMTemplateStorageResourceAssoc.Status.DOWNLOADED);
