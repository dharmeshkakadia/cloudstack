...
import org.apache.simulator.MockSecStorageVO;
import org.apache.simulator.MockStoragePoolVO;
import org.apache.simulator.MockVMVO;
import org.apache.simulator.MockVm;
import org.apache.simulator.MockVolumeVO;
import org.apache.simulator.MockVolumeVO.MockVolumeType;
import org.apache.simulator.dao.MockHostDao;
import org.apache.simulator.dao.MockSecStorageDao;
import org.apache.simulator.dao.MockStoragePoolDao;
import org.apache.simulator.dao.MockVMDao;
import org.apache.simulator.dao.MockVolumeDao;
        ...
        try {
            ...
            if (pct >= 1.0) {
                ...
                return new DownloadAnswer(cmd.getJobId(), 100, cmd,
                        org.apache.storage.VMTemplateStorageResourceAssoc.Status.DOWNLOADED, volume.getPath(),
                        volume.getName());
            } else {
                _mockVolumeDao.update(volume.getId(), volume);
                txn.commit();
                return new DownloadAnswer(cmd.getJobId(), (int) (pct * 100.0), cmd,
                        org.apache.storage.VMTemplateStorageResourceAssoc.Status.DOWNLOAD_IN_PROGRESS, volume.getPath(),
                        volume.getName());
            }
        } catch (Exception ex) {
            txn.rollback();
