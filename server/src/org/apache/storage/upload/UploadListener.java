...
import org.apache.agent.api.storage.UploadProgressCommand.RequestType;
...
import org.apache.storage.upload.UploadState.UploadEvent;
...
public class UploadListener implements Listener {
    ...
    @Override
    public boolean processDisconnect(long agentId, org.apache.host.Status state) {
        setDisconnected();
        return true;
    }
    ...
    public void scheduleStatusCheck(org.apache.agent.api.storage.UploadProgressCommand.RequestType getStatus) {
        if (statusTask != null)
            statusTask.cancel();
