...
import org.apache.exception.CloudAuthenticationException;
...
import org.apache.projects.dao.ProjectAccountDao;
...
public class QueryManagerImpl extends ManagerBase implements QueryService {
     ...
     *
     * @see
     * org.apache.api.query.QueryService#searchForUsers(org.apache.cloudstack
    ...
    private Pair<List<EventJoinVO>, Integer> searchForEventsInternal(ListEventsCmd cmd) {
        ...
        if ((entryTime != null) && (duration != null)) {
             ...
             *
             * sc.setParameters("state", org.apache.event.Event.State.Completed);
