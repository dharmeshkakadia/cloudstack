...
import org.apache.network.vpc.dao.VpcOfferingServiceMapDao;
...
public class MockVpcOfferingServiceMapDaoImpl extends GenericDaoBase<VpcOfferingServiceMapVO, Long> implements VpcOfferingServiceMapDao{
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcOfferingServiceMapDao#listByVpcOffId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcOfferingServiceMapDao#areServicesSupportedByNetworkOffering(long, org.apache.network.Network.Service[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcOfferingServiceMapDao#listServicesForVpcOffering(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcOfferingServiceMapDao#findByServiceProviderAndOfferingId(java.lang.String, java.lang.String, long)
     */
    @Override
