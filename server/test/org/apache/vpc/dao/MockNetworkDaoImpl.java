...
import org.apache.network.dao.NetworkAccountVO;
...
public class MockNetworkDaoImpl extends GenericDaoBase<NetworkVO, Long> implements NetworkDao{
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByOwner(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listBy(long, long, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listBy(long, long, java.lang.String, boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByZoneAndGuestType(long, long, org.apache.network.Network.GuestType, java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#persist(org.apache.network.NetworkVO, boolean, java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#createSearchBuilderForAccount()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getNetworksForOffering(long, long, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getNextAvailableMacAddress(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listBy(long, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#countByZoneAndUri(long, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#countByZoneUriAndGuestType(long, java.lang.String, org.apache.network.Network.GuestType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByZone(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#changeActiveNicsBy(long, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getActiveNicsIn(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#findNetworksToGarbageCollect()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#clearCheckForGc(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByZoneSecurityGroup(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#addDomainToNetwork(long, long, java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByPhysicalNetwork(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listSecurityGroupEnabledNetworks()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByPhysicalNetworkTrafficType(long, org.apache.network.Networks.TrafficType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listBy(long, long, org.apache.network.Network.GuestType, org.apache.network.Networks.TrafficType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByPhysicalNetworkAndProvider(long, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#persistNetworkServiceProviders(long, java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#update(java.lang.Long, org.apache.network.NetworkVO, java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByZoneAndTrafficType(long, org.apache.network.Networks.TrafficType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#setCheckForGc(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getNetworkCountByNetworkOffId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#countNetworksUserCanCreate(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listSourceNATEnabledNetworks(long, long, org.apache.network.Network.GuestType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getNetworkCountByVpcId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listByVpc(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#getPrivateNetwork(java.lang.String, java.lang.String, long, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#countVpcNetworks(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.dao.NetworkDao#listNetworksByAccount(long, long, org.apache.network.Network.GuestType, boolean)
     */
    @Override
