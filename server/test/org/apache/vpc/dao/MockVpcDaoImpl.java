...
import org.apache.network.vpc.Vpc.State;
...
public class MockVpcDaoImpl extends GenericDaoBase<VpcVO, Long> implements VpcDao{
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcDao#getVpcCountByOfferingId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcDao#getActiveVpcById(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcDao#listByAccountId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcDao#listInactiveVpcs()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.network.vpc.Dao.VpcDao#countByAccountId(long)
     */
    @Override
